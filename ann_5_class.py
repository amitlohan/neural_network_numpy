...
data_X,labels_Y = get_cifar_5_class_hogs() #Retrive hog features and labels for the training images 
X_test,Y_test = get_cifar_5_test_class_hogs() #Retirves hos featrues and labels for the test images
